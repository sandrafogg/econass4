...
MC_100_A<-(-slope_a_d*100) + int_a 
MC_100_B<-(slope_b_d*100) + int_b
MC_100_C<-(slope_c_d*100) + int_c
...
```
The total cost for Sector A is $3748.6572
The total cost for Sector B is $294.8727
The total cost for Sector C is $4819.7660
The total cost for country X is $8863.2959.
There is no tax revenue for this policy option. 
...
#For Sector A
A_demand_x_intercept <- (-int_a/-slope_a_d)
A_demand_x_intercept
A_demand_x_slope <- (1/-slope_a_d)
A_demand_tax <- function(x){A_demand_x_intercept + A_demand_x_slope*x}


#For Sector B
B_demand_x_intercept <- (-int_b/slope_b_d)
B_demand_x_slope <- (1/slope_b_d)
B_demand_tax <- function(x){B_demand_x_intercept + B_demand_x_slope*x}


#For Sector C
C_demand_x_intercept <- (-int_c/slope_c_d)
C_demand_x_slope <- (1/slope_c_d)
C_demand_tax <- function(x){C_demand_x_intercept + C_demand_x_slope*x}
...
=======
```{r}
>>>>>>> 4accbe4a51dc0260faefa397cec6ec39de0de917
